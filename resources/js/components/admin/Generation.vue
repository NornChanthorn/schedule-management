<template>
   <Toast/>
    <div class="flex items-center mb-2 hover:underline hover:text-bule-700">
        <h1 class="text-custom-color-small font-istok text-4xl font-bold ml-4 btn" @click="backRoute" >{{ majorName1 }}</h1>
