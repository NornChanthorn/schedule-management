<template>
  <Toast />
  <div
    class="lg:flex lg:justify-between items-center mb-2 md:inline hover:text-bule-700"
  >
    <h1 class="text-custom-color-small font-istok text-4xl font-bold">
      Course List
    </h1>
    <div
      class="flex justify-evenly items-center lg:w-[32%] md:w-[80%] md:mt-2 sm:mt-8"
    >
      ...
      <form action="" @submit.prevent="addNewCourse">
        <div class="flex justify-between gap-4">
          <div class="lg:justify-between items-center mb-4 w-[50%]">
            ...
            />
            <small class="p-error" v-if="submitted && !addCourse.name"
          ...
          <div class="lg:justify-between items-center mb-4 w-[50%]">
            ...
            <small class="p-error" v-if="submitted && !addCourse.teacher_id"
        ...
        <div class="flex justify-between gap-4">
          <div class="lg:justify-between items-center mb-4">
            ...
            <small class="p-error" v-if="submitted && !addCourse.major_id"
          ...
          <div class="lg:justify-between items-center mb-4">
            ...
            <small class="p-error" v-if="submitted && !addCourse.gen_id"
              >Generation is required</small
            >
          </div>
        </div>
        ...
        <div class="lg:justify-between items-center mb-4">
          ...
          <small class="p-error" v-if="submitted && !addCourse.term_id"
        ...
        <div class="lg:justify-between items-center mb-4">
          ...
          <input
            type="text"
            v-model="addCourse.duration"
            class="mt-1 p-2 w-full border rounded outline outline-slate-200 py-2 px-3 leading-tight focus:outline-none focus:shadow-outline focus:outline-blue-200"
            placeholder="Duration (Ex: 45 hours)"
            :class="{
              ' border-red-500  outline outline-red-200 hover:outline-red-200':
                submitted && !addCourse.duration,
            }"
          />
          <small class="p-error" v-if="submitted && !addCourse.duration"
        ...
        <div class="flex justify-between mt-6">
          <button
            ...
            class="w-32 bg-red-500 mr-2 text-white border-2 hover:bg-red-700"
          >
            Cancel
          </button>
          <button
            type="submit"
            class="w-32 py-2 bg-blue-500 border-2 text-white hover:bg-blue-700"
          >
            Save
          </button>
        </div>
      ...
      <form action="" @submit.prevent="editCourse(course.id)">
        <div class="flex justify-between gap-4">
          <div class="lg:justify-between items-center mb-4">
            ...
            />
            <small class="p-error" v-if="submitted && !course.name"
              >Course is required</small
            >
          </div>
          <div class="lg:justify-between items-center mb-4">
            <label for="name" class="text-lg mr-2 mb-2">Teacher</label>
            <select
              v-model.trim="course.teacher_id"
              class="mt-1 p-2 w-full border rounded outline outline-slate-200 py-2 px-3 leading-tight focus:outline-none focus:shadow-outline focus:outline-blue-200"
              :class="{
                ' border-red-500  outline outline-red-200 hover:outline-red-200':
            ...
            <small class="p-error" v-if="submitted && !course.teacher_id"
              >Teacher is required</small
            >
          </div>
        </div>
        <div class="flex justify-center gap-4">
          <div class="lg:justify-between items-center mb-4">
            ...
            <small class="p-error" v-if="submitted && !course.major_id"
              >Major is required</small
            >
          </div>
          <div class="lg:justify-between items-center mb-4">
            ...
            <small class="p-error" v-if="submitted && !course.gen_id"
              >Generation is required</small
            >
          </div>
        </div>
        ...
        <div class="lg:justify-between items-center mb-4">
          ...
          <small class="p-error" v-if="submitted && !course.term_id"
            >Term is required</small
          >
        </div>
        <div class="lg:justify-between items-center mb-4">
          ...
          />
          <small class="p-error" v-if="submitted && !course.duration"
            >Duration is required</small
          >
        </div>
        <div class="flex justify-between mt-6">
...
export default {
  ...
  methods: {
    ...
    async handleTabChange(newTab) {
      ...
      try {
        const response = await axios.get(
          this.selectedTabId != 0 ? `courseMajor/${id}` : `courses`
    ...
    editCourse(id) {
      this.submitted = true;
      axios.put(`courses/${id}`, this.course).then((res) => {
        this.getCourse();
