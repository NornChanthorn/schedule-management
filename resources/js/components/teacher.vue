<template>
  <div class="flex items-center mb-4 ml-4">
    ...
    <div class="flex items-ceter justify-center ml-16">
      <router-link
        to="/teacher"
        :class="{ 'active-link': $route.path === '/teacher' }"
        class="w-16 ml-auto text-black px-2 py-2 hover:bg-blue-100 nav-link"
        >All</router-link
      >
      <router-link
        to="/ga"
    ...
    <div class="flex mt-4 sm:mt-0 ml-auto items-center">
      <button
        class="ml-auto bg-green-500 text-white px-2 py-2 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 mr-2"
        label="Add New"
        severity="secondary"
        ...
        <form @submit.prevent="createPost">
          ...
          <div class="flex items-center justify-end mt-4 gap-x-2">
            <button
              ...
              type="button"
              class="w-32 py-2 bg-gray-600 text-white hover:bg-gray-400"
            >
              Cancel
            </button>
            <button
              type="submit"
              class="w-32 py-2 bg-blue-600 mr-2 text-white border border-2 hover:bg-blue-400"
            >
              Save
            </button>
          </div>
