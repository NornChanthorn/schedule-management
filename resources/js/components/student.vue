<template>
  <div class="flex items-center mb-4 ml-4">
    ...
    <div class="flex items-ceter justify-center ml-16">
      <router-link
        to="/student"
        :class="{ 'active-link': $route.path === '/student' }"
    ...
    <div class="flex mt-4 sm:mt-0 ml-auto items-center">
      <button
        class="cursor-pointer ml-auto bg-green-500 text-white px-2 py-2 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 mr-2"
        label="Add New"
        severity="secondary"
