<template>
  ...
  <div class="font-istok ">
    <div v-for="majors in courseteacher" :key="majors.id">
      ...
      <!-- <a href="/Schedules">
        <div v-if="majors.showDetails" class="details-container">
      ...
      :to="{ name: 'schedules', params: { name: majors.major.name, majorId: majors.major.id, genid: majors.generation.id, termId: majors.term.id } }"
