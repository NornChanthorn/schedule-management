        ...
        <div class="flex item-center justify-center mt-8">
            <div class="w-2/3">
                <div class="mb-4" v-if="user.role=='teacher'">
                    ...
                    <input type="text" v-model="teacher.title" id="title" class="mt-1 p-2 w-full border rounded outline-none focus:outline-blue-200">
                </div>
                ...
                <div class="mb-4" v-else>
                    ...
                    <input type="text" v-model="user.name" id="email" class="mt-1 p-2 w-full border rounded outline-none focus:outline-blue-200">
                </div>
                <div class="mb-4" v-if="user.role=='teacher'">
                    <label for="gender" class="block text-m font-medium text-gray-700">Gender</label>
                    <input type="text" v-model="teacher.gender" id="gender" class="mt-1 p-2 w-full border rounded outline-none focus:outline-blue-200">
                </div>
                ...
                <div class="flex justify-start mt-6">
                    ...
                    <button @click="save(teacher)" class="w-32 px-4 py-2 text-white rounded border-2 bg-blue-500 hover:bg-blue-700">Save</button>
                </div>
            </div>
        </div>
   </form>
